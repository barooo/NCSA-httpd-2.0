...
pkgdatadir = $(datadir)/httpd
pkgincludedir = $(includedir)/httpd
pkglibdir = $(libdir)/httpd
pkglibexecdir = $(libexecdir)/httpd
...
OBJEXT = o
PACKAGE = httpd
PACKAGE_BUGREPORT = jrichardson@ncsasports.org
PACKAGE_NAME = httpd
PACKAGE_STRING = httpd 1.0
PACKAGE_TARNAME = httpd
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
